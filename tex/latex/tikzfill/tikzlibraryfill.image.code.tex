...
%%
\ProvidesFile{tikzlibraryfill.image.code.tex}[2026/04/23 v1.2.0 Image filling library]

\ExplSyntaxOn

\dim_zero_new:N \l__tikzfill_tmpa_dim
\dim_zero_new:N \l__tikzfill_tmpb_dim
...
\cs_new_nopar:Npn \__tikzfill_img_include_graphics:n #1
  {
    \tl_if_empty:NTF \l__tikzfill_img_graphics_options_tl
      {
        \includegraphics { #1 }
      }
      {
        \exp_args:NNV \includegraphics [ \l__tikzfill_img_graphics_options_tl ] { #1 }
      }
  }
...
\cs_new_nopar:Npn \__tikzfill_img_compute_scales:
  {
    \dim_set:Nn \l__tikzfill_tmpa_dim { \box_wd:N \l__tikzfill_img_box }
    \dim_compare:nNnTF { \l__tikzfill_tmpa_dim } < { 1pt }
      {
      ...
      }
      {
        \fp_set:Nn \l__tikzfill_img_scale_x_fp
          {
            \l__tikzfill_img_scale_tl * \l__tikzfill_img_width_tl / \l__tikzfill_tmpa_dim
          }
      }
    \dim_set:Nn \l__tikzfill_tmpb_dim { \box_ht:N \l__tikzfill_img_box + \box_dp:N \l__tikzfill_img_box }
    \dim_compare:nNnTF { \l__tikzfill_tmpb_dim } < { 1pt }
      {
      ...
      }
      {
        \fp_set:Nn \l__tikzfill_img_scale_y_fp
          {
            \l__tikzfill_img_scale_tl * \l__tikzfill_img_height_tl / \l__tikzfill_tmpb_dim
          }
      }
  }
...
\cs_new_nopar:Npn \__tikzfill_img_shrink_draw_box:
  {
    ...
    \fp_compare:nNnTF { \l__tikzfill_img_scale_x_fp } > { \l__tikzfill_img_scale_y_fp }
      { \fp_set_eq:NN \l__tikzfill_img_scale_x_fp \l__tikzfill_img_scale_y_fp }
      { \fp_set_eq:NN \l__tikzfill_img_scale_y_fp \l__tikzfill_img_scale_x_fp }
    \fp_compare:nNnT { \l__tikzfill_img_scale_x_fp } > { \c_one_fp }
      {
        \fp_set_eq:NN \l__tikzfill_img_scale_x_fp \c_one_fp
        \fp_set_eq:NN \l__tikzfill_img_scale_y_fp \c_one_fp
      }
